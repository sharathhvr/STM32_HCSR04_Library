 ...
 *      Author: SHARATH
 *
 *      Note: This library is implemented for channel 1 of any timer , to change the channel, change TIM_IT_CC1, HAL_TIM_ACTIVE_CHANNEL_1,TIM_IT_CC1 in code accordingly
 */
